...
5. If not, it generates all possible variations with between one and the specified maximum number of digits changed.
...
- For a 9-digit number with up to 2 digits off: 2,997 variations
- For a 9-digit number with up to 3 digits off: 64,233 variations
